          ...
          {users.map((user, index) => (
            <tr key={user.id} className={`${index % 2 === 0 ? "bg-gray-50" : "bg-white"
              ...
              <td className="flex justify-center py-2 text-sm text-gray-700">
                <button type="button" className="w-15 h-6 flex justify-center items-center text-green-600 gap-2 border rounded-sm cursor-pointer">
                  <BiEdit />
                  <span>Edit</span>
                </button>
              </td>
